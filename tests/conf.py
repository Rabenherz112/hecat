...
html_use_opensearch = 'https://awesome-selfhosted.example.org'
html_favicon = 'awesome-selfhosted-data/_static/favicon.ico'
html_logo = 'awesome-selfhosted-data/_static/logo.svg'
